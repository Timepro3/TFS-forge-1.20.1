...
public class ModelingRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    private ItemStack result;
    private ItemStack ingredients;
    private List<String> map = Lists.newArrayList();
    private final Advancement.Builder advancement = Advancement.Builder.recipeAdvancement();

    public ModelingRecipeBuilder(ItemStack pResult, ItemStack ingredients) {
        this.result = pResult;
        this.ingredients = ingredients;
    }

    public static ModelingRecipeBuilder modeling(Item pResult, int pCount, Item ingredients, int Count) {
        return new ModelingRecipeBuilder(new ItemStack(pResult, pCount), new ItemStack(ingredients, Count));
    }

    public ModelingRecipeBuilder pattern(String pPattern) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new ModelingRecipeBuilder.Result(pRecipeId, CraftingBookCategory.MISC, this.result, this.ingredients, this.map, this.advancement, pRecipeId.withPrefix("recipes/alloying/")));
    }
    ...
    public static class Result extends CraftingResult {
        ...
        public RecipeSerializer<?> getType() {
            return TFSRecipes.MODELING_SERIALIZER.get();
        }
