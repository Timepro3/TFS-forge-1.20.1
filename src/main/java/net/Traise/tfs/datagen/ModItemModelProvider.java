    ...
    protected void registerModels() {
        {
            ...
            simpleItem(TFSItems.COPPER_INGOT_FORM);
            simpleItem(TFSItems.IRON_INGOT_FORM);
            simpleItem(TFSItems.TIN_INGOT_FORM);
            simpleItem(TFSItems.ZINC_INGOT_FORM);
            simpleItem(TFSItems.GOLD_INGOT_FORM);
            simpleItem(TFSItems.SILVER_INGOT_FORM);
            simpleItem(TFSItems.BRONZE_INGOT_FORM);
            simpleItem(TFSItems.BRASS_INGOT_FORM);
            simpleItem(TFSItems.UNKNOWN_METAL_INGOT_FORM);
            simpleItem(TFSItems.STEEL_INGOT_FORM);
            simpleItem(TFSItems.CAST_IRON_INGOT_FORM);
