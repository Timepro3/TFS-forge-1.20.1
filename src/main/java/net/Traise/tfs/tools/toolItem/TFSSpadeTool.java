...
public class TFSSpadeTool extends TFSBaseItem {
    public TFSSpadeTool(Properties pProperties) {
        super(BlockTags.MINEABLE_WITH_SHOVEL, 0.5f, 6, -2.5f, ToolActions.DEFAULT_SHOVEL_ACTIONS, pProperties);
    }
