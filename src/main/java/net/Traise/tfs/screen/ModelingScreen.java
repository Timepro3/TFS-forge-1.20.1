...
public class ModelingScreen extends AbstractContainerScreen<ModelingMenu> {
    private static final ResourceLocation texture = new ResourceLocation("tfs:textures/gui/modeling_gui.png");

    public ModelingMenu cuttingMenu;
    ...
    public ModelingScreen(ModelingMenu container, Inventory inventory, Component text) {
