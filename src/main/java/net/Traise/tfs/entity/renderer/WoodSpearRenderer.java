...
public class WoodSpearRenderer extends EntityRenderer<ThrownWoodSpear> {
    private final WoodSpearModel bone;

    public WoodSpearRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.bone = new WoodSpearModel(pContext.bakeLayer(ModModelLayers.WOOD_SPEAR_LAYER));
    }

    @Override
    public ResourceLocation getTextureLocation(ThrownWoodSpear pEntity) {
        return new ResourceLocation("tfs:textures/entity/wood_spear.png");
    }

    @Override
    public void render(ThrownWoodSpear pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
