...
public class GoldSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation GOLD_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "gold_spear"), "main");

	public GoldSpearModel(ModelPart root) {
