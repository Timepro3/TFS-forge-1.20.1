...
public class SilverSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation SILVER_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "silver_spear"), "main");

	public SilverSpearModel(ModelPart root) {
