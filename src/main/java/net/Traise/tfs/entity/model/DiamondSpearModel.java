...
public class DiamondSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation DIAMOND_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "diamond_spear"), "main");
