...
public class IronSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation IRON_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "iron_spear"), "main");
