...
public class RockSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation ROCK_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "rock_spear"), "main");

	public RockSpearModel(ModelPart root) {
