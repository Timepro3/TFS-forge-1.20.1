...
public class NetheriteSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation NETHERITE_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "netherite_spear"), "main");

	public NetheriteSpearModel(ModelPart root) {
