...
public class SteelSpearModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart bone;
	public static final ModelLayerLocation STEEL_SPEAR = new ModelLayerLocation(new ResourceLocation
			("tfs", "steel_spear"), "main");

	public SteelSpearModel(ModelPart root) {
