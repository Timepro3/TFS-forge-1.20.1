...
public class ModLimoniteOre extends Region {
    public ModLimoniteOre(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.LIMONITE_DEPOSIT));
