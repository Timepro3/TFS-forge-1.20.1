...
public class ModSilverOre extends Region {
    public ModSilverOre(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.SILVER_DEPOSIT));
