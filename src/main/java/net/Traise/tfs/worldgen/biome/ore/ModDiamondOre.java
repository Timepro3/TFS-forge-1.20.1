...
public class ModDiamondOre extends Region {
    public ModDiamondOre(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.DIAMOND_DEPOSIT));
