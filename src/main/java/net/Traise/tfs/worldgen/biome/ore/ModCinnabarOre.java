...
public class ModCinnabarOre extends Region {
    public ModCinnabarOre(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.CINNABAR_DEPOSIT));
